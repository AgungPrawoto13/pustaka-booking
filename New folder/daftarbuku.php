 			 ...
 			 <div class="row">                         
 			 	...
 			 	<?php foreach ($buku as $buku) { ?>                             
 			 		...
 			 		<div class="thumbnail" style="height: 370px;">                                     
 			 			<img src="<?= base_url('assets/');?>img/logo/<?= $buku->image ?>" style="max-width:100%; maxheight: 100%; height: 200px; width: 180px"> 
 
 		 <div class="caption">                                         
 		 	<h5 style="min-height:30px;"><?= $buku->pengarang ?></h5>                                        <h5><?= $buku->penerbit ?></h5>                                         
