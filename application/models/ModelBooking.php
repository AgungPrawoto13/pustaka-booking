<?php if(!defined('BASEPATH'))exit('No diret script access allowed');
...
class ModelBooking extends CI_Model
{
	...
	{
		$this->db->query('CREATE TABLE IF NOT EXISTS temp(id_booking varchar(12), tgl_booking DATETIME, email_user varchar(30),id_buku int)');
	}
