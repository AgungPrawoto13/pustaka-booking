...
<html>
	...
	<div class="container">
		...
		<div class="nav">
				...
				<a href="<?= base_url('website/C_Membuat_website/tampil_login');?>"><li>Masuk</li></a>
			</ul>
			</div>
		</div>
		...
		<div class="pemula"><!--pemula-->
			...
			<div class="TentangKami"><!--TentangKami-->
				...
				<div class="sosmed"><!--Sosmed-->
					...
					<a href="https://twitter.com/niniksulis16"><img src="<?= base_url('assets/');?>css/New folder/images/55.png"></a>
