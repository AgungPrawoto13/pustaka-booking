		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				...
				if($this->session->userdata('email')){
					?>
					<a class="nav-item nav-link" href="<?= base_url('booking');?>">Booking <b><?= $this->ModelBooking->getDataWhere('temp',array('email_user'=>$this->session->userdata('email')))->num_rows();?></b>Buku</a>
