		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="<?php echo base_url().'admin/logout';?>"><span class="glyphicon glyphicon-log-out"></span>Logout</a>
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" ariaexpanded="false"><?php echo "Halo, <b>".$this->session->userdata('nama');?><span class="caret"></span></a></li>
