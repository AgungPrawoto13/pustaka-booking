	...
	<div class="x_content">
		<div class="row">
			<div class="col-sm-3 col-md-3">
				<div class="thumbnail" style="height:auto; position: relative; left:100%; width:300%;">
					<img src="<?php echo base_url();?>assets/img/logo/<?= $gambar; ?>" style="max-width:100%; max-height:200%; height:300px; width:300px">

					<div class="caption">
						<h5 style="min-height:100px;" align="center"><?= $pengarang ?></h5>
						<center>
